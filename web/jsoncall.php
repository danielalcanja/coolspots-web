	...
	<tr>
		...
		<td>
			<select name="url" id="url" onchange="$('#resultado').hide();">
				...
				<option value="/json/geo/cities">/json/geo/cities</option>
				<option value="/json/geo/cities/search">/json/geo/cities/search</option>
				<option value="/json/geo/countries">/json/geo/countries</option>
				<option value="/json/geo/countries/search">/json/geo/countries/search</option>
				<option value="/json/geo/states">/json/geo/states</option>
				<option value="/json/geo/states/search">/json/geo/states/search</option>
				<option value="/json/inbox">/json/inbox</option>
				<option value="/json/inbox/add">/json/inbox/add</option>
				<option value="/json/inbox/read">/json/inbox/read</option>
				<option value="/json/inbox/remove">/json/inbox/remove</option>
				<option value="/json/inbox/sent">/json/inbox/sent</option>
				<option value="/json/inbox/sent/read">/json/inbox/sent/read</option>
